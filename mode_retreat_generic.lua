function GetDesire()
	...
	local TableNearbyEnemyHeroes = npcBot:GetNearbyHero(1600,true,BOT_MODE_NONE);
	local TableNearbyFriendlyHeroes = npcBot:GetNearbyHero(1000,false,BOT_MODE_NONE);
