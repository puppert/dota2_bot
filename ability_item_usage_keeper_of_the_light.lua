...
function ConsiderIllumiante()
	...
	local abilityIlluminate = npcBot.ability["abilityIlluminate"]
...
function ConsiderManaLeak()
	...
	local abilityManaLeak = npcBot.ability["abilityManaLeak"]
...
function ConsiderChakraMagic()
	local npcBot= GetBot();
	local abilityChakraMagic = npcBot.ability["abilityChakraMagic"]
...
function ConsiderSpiritForm()
	...
	local abilitySpiritForm = npcBot.ability["abilitySpiritForm"]
...
function ConsiderRecall()
	...
	local abilityRecall = npcBot.ability["abilityRecall"]
...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
function ConsiderBlinding()
	local npcBot = GetBot();
	
	local abilityBlindingLight = npcBot.ability["abilityBlindingLight"]
...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
function ConsiderSIlluminate()
	local npcBot = GetBot();
	if npcBot:HasModifier("modifier_keeper_of_the_light_spirit_form") then
		return BOT_ACTION_DESIRE_NONE,0;
	end
	local abilitySpiritFormIlluminate = npcBot.ability["abilitySpiritFormIlluminate"]
	...
	if npcBot:GetLevel() == 25 then
		nTotalDamage = nTotalDamage +abilitySpiritFormIlluminate:GetSpecialValueInt("LinkedSpecialBonus");
	end
...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
function ConsiderSIlluminateEnd()
	local npcBot = GetBot();
	local abilitySpiritFormIlluminate = npcBot.ability["abilitySpiritFormIlluminate"] 
